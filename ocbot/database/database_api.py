...
from keys import PG_USERNAME, PG_PASSWORD, PG_URL, PA_SSH_PASSWORD, PA_SSH_URL, PA_SSH_USERNAME, \
...
if __name__ == '__main__':
    ...
    with SSHTunnelForwarder(
            ...
            remote_bind_address=(PA_SSH_REMOTE_BIND_ADDR, PA_SSH_REMOTE_BIND_PORT),  # IP Addr of postgres server
    ) as server:
        ...
        print(type(db.get_user('fake@email.com')))  # 1 | Billy | Boberson | fake@email.com | [Java, Python]
        db.close_all()
